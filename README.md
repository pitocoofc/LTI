...
const extMap = {
    ...
    '.cpp': 'C++', '.html': 'HTML', '.css': 'CSS', '.rb': 'Ruby', '.rs': 'Rust',
    '.ts': 'TypeScript', '.php': 'PHP', '.go': 'Go', '.swift': 'Swift', '.kt': 'Kotlin',
    '.cs': 'C#', '.sh': 'Shell Script', '.sql': 'SQL', '.dart': 'Dart', '.r': 'R',
    '.ex': 'Elixir', '.clj': 'Clojure', '.scala': 'Scala', '.f90': 'Fortran',
    '.cbl': 'COBOL', '.pas': 'Pascal', '.ada': 'Ada', '.lisp': 'Lisp', '.pl': 'Perl',
    '.asm': 'Assembly', '.m': 'Objective-C', '.bas': 'BASIC', '.bf': 'Brainfuck',
    '.ws': 'Whitespace', '.lol': 'LOLCODE', '.i': 'INTERCAL', '.cow': 'COW',
    '.spl': 'Shakespeare', '.piet': 'Piet', '.mal': 'Malbolge', '.arnoldc': 'ArnoldC',
    '.b98': 'Befunge', '.json': 'JSON', '.yaml': 'YAML', '.md': 'Markdown',
    '.xml': 'XML', '.toml': 'TOML'
};
